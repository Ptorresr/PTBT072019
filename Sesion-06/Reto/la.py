...
---
Se cambia el nombre del script de listaarchivos.py a la.py para usarlo como comando de forma más práctica.
---
Sesion-06/Reto:

    Consiste en realizar los cambios necesario para imprimir la lista de los
    archivos de la carpeta indicada y además los archivos de las carpetas
    presentes.
    ...
    ../Datos/readme.md
    ../Datos/Muestra-1/
    ../Datos/Muestra-1/serie-1.csv
    ../Datos/Muestra-1/serie-2.csv
    ../Datos/Muestra-2/
    ../Datos/Muestra-2/2019/
    ../Datos/Muestra-2/2020/
    ../Datos/muestra-3/serie-1.csv
---
"""
